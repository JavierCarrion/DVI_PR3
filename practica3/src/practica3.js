...
//-------------ANIMATIONS-------------
	...
	Q.animations("goomba", {
		move_right: 	{ frames: [0], rate: 1/9 }, 
		move_left: 		{ frames: [1], rate: 1/9 },
		died: 			{ frames: [2], rate: 1/5, loop: false, trigger: "died" }
	});

	Q.animations("bloopa", {
		move_up: 		{ frames: [0], rate: 1/9 }, 
		move_down: 		{ frames: [1], rate: 1/9 },
		died: 			{ frames: [2], rate: 1/5, loop: false, trigger: "died" }
	});
